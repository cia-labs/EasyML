...
import { Button, View, Text, Image, Platform, Alert, PermissionsAndroid } from 'react-native';
...
const AddImage: React.FC = () => {
  ...
  const uploadImages = async () => {
    ...
    const base64ImagesList = base64images.join(',');
    formData.append('image', base64ImagesList);
